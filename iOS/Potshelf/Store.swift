...
final class Store: ObservableObject {
    ...
    private let fileName = "potshelf_entries.json"
    ...
    static func seedData() -> [PlantEntry] {
        let now = Date()
        return [
            PlantEntry(title: "Sample Plant One", detail1: "Example", detail2: "Example", note: "Tap + to add your own.", date: now),
            PlantEntry(title: "Sample Plant Two", detail1: "Example", detail2: "Example", note: "", date: now.addingTimeInterval(-86400))
        ]
    }
}
