...
final class PotshelfUITests: XCTestCase {
    ...
    func testAddEntryFlow() {
        ...
        titleField.tap()
        titleField.typeText("New Plant")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["New Plant"].waitForExistence(timeout: 2))
    }
